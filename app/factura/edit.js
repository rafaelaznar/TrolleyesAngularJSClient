miModulo.controller("facturaEditController", [
    ...
    function ($scope, auth, $location, ajaxService, $routeParams) {
        ...
        $scope.save = function () {
            var datos = JSON.stringify({ fecha: moment($scope.fecha).format("DD/MM/YYYY hh:mm"), iva: $scope.entity.iva, usuario: $scope.entity.usuario.id, pagado: $scope.entity.pagado  });
